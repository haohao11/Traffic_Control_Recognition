...
The following figure demonstrates a junction with *lower_threshold*=10 and *upper_theshold*=100.
![junction](https://github.com/haohao11/Junctions/blob/master/analysis/junctTrajs_0089_165.png)
